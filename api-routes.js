...
// Doi tuong
var participantController = require('./api/participants/partController');
// participant routes
...
// Nhom doi tuong
var participantGroupController = require('./api/participantGroups/partGroupController');
// participantGroup routes
...
// Don vi
var unitController = require('./api/units/unitController');
// unit routes
router.route('/units')
...
// Cap bac
var rankController = require('./api/ranks/rankController');
// rank routes
router.route('/ranks')
...
// Chuc vu
var jobController = require('./api/jobs/jobController');
// job routes
router.route('/jobs')
...
// Quyen
var roleController = require('./api/roles/roleController');
// role routes
router.route('/roles')
...
// Gioi tinh
var genderController = require('./api/genders/genderController');
// gender routes
...
// Tai khoan
var accountController = require('./api/accounts/accountController');
// account routes
...
// Ke hoach
var planController = require('./api/plans/planController');
// plan routes
router.route('/plans')
...
// Don vi tinh
var measureUnitController = require('./api/measureUnits/measureUnitController');
// measureUnit routes
...
// Noi dung kiem tra
var contentGroupController = require('./api/contentGroups/contentGroupController');
// content routes
router.route('/contentGroups')
    .get(contentGroupController.index)
    .post(contentGroupController.new);
router.route('/contentGroups/:contentGroup_id')
    .get(contentGroupController.view)
    .patch(contentGroupController.update)
    .put(contentGroupController.update)
    .delete(contentGroupController.delete);

// Quan nhan
var soldierController = require('./api/soldiers/soldierController');
// soldier routes
